...
const tuesdayBootCampBooker = schedule.scheduleJob({hour: 21, minute: 0, second: 29, dayOfWeek: 5}, function(){
    book.bookTrainingClass(tuesdayBootCamp, "Bootcamp tirsdag");
});
const thursdayBootCampBooker = schedule.scheduleJob({hour: 21, minute: 0, second: 31, dayOfWeek: 0}, function(){
